...
if global.broken{
	...
	draw_healthbar(display_get_gui_width() - 33, display_get_height() /3, display_get_gui_width() - 20, (2*display_get_height()/3), time_left, c_black,c_red, c_yellow, 3, true, true);
}
...
if (room == rm_game || room = rm_arena){
	...
	draw_text(display_get_gui_width()/2, 30, title);
}
